            ...
            <div class="row">
                <div class="col-12">	
                    ...
                    <div class="row"> <!-- start 7th row -->
                        ...
                        <div class="controls">
                            <textarea name="short_descp_en" id="textarea" class="form-control" placeholder="Short description in english"></textarea>
                        </div>
                        </div>
                        </div> <!-- end col md 6 -->
                        ...
                        <div class="controls">
                            <textarea name="short_descp_ro" id="textarea" class="form-control" placeholder="Short description in romanian"></textarea>
                        </div>
                        </div>
                        </div> <!-- end col md 6 -->
