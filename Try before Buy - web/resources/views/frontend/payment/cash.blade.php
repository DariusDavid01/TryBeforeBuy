...
@section('content')
@section('title')
@if(session()->get('language') == 'romanian') Plata cash @else Cash payment @endif
@endsection
	...
	<div class="container">
		<div class="breadcrumb-inner">
			<ul class="list-inline list-unstyled">
				...
				<li class='active'>@if(session()->get('language') == 'romanian') Plata cash @else Cash on delivery @endif</li>
			</ul>
	...
	<div class="panel-group">
		<div class="panel panel-default">
			<div class="panel-heading">
		    	<h4 class="unicase-checkout-title">@if(session()->get('language') == 'romanian') Totalul de cumparaturi @else Your shopping amount @endif</h4>
		    </div>
		    <div class="">
		...
		<div class="panel panel-default">
		    ...
		    <form action="{{route('cash.order')}}" method="post" id="payment-form">
					...
					<img src="{{asset('frontend/assets/images/payments/cash.png')}}">
                        ...
                        <br>
                        <button class="btn btn-primary">@if(session()->get('language') == 'romanian') Selecteaza @else Select @endif</button>
                        </form>
		</div>
	</div>
</div> 
