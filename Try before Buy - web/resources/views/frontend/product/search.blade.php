...
@section('content')
@section('title')
@if(session()->get('language') == 'romanian') Cautare produs @else Product search @endif
@endsection
  ...
  <div class='container'>
    <div class='row'>
      ...
      <div class='col-md-9'> 
        ...
        <h4>
            <b>@if(session()->get('language') == 'romanian') Rezultate gasite: @else Found results:  @endif</b>
            <span class="badge badge-danger" style="background: #FF0000">{{count($products)}}</span> @if(session()->get('language') == 'romanian') produse @else items @endif
        </h4>
