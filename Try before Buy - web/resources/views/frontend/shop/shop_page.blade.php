...
@section('content')
@section('title')
@if(session()->get('language') == 'romanian') Magazin @else Shop @endif
@endsection
  ...
  <div class="container">
    <div class="breadcrumb-inner">
      <ul class="list-inline list-unstyled">
        <li><a href="#">@if(session()->get('language') == 'romanian') Pagina magazin @else Shop page @endif</a></li>
        ...
        <div class="sidebar-module-container">
          <div class="sidebar-filter"> 
            ...
            <div class="sidebar-widget wow fadeInUp">
              <h3 class="section-title">@if(session()->get('language') == 'romanian') cumpara dupa @else shop by @endif</h3>
