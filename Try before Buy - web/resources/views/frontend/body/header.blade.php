      ...
      <div class="header-top-inner">
        <div class="cnt-account">
          <ul class="list-unstyled">
            ...
            @auth
            <li><a href="{{route('user.profile')}}"><i class="icon fa fa-user"></i>@if(session()->get('language') == 'romanian') Profil @else User Profile @endif</a></li>
            @else
            ...
            <form method="post" action="{{route('product.search')}}">
              ...
              <div class="control-group">
                <ul class="categories-filter animate-dropdown">
                  <li class="dropdown"> <a class="dropdown-toggle"  data-toggle="dropdown" href="category.html">@if(session()->get('language') == 'romanian') Categorii @else Categories @endif<b class="caret"></b></a>
                    <ul class="dropdown-menu" role="menu" >
                      <li class="menu-header">@if(session()->get('language') == 'romanian') Watches @else Ceasuri @endif</li>
                      <li role="presentation"><a role="menuitem" tabindex="-1" href="category.html">- @if(session()->get('language') == 'romanian') Casual @else Casual @endif</a></li>
                      <li role="presentation"><a role="menuitem" tabindex="-1" href="category.html">- @if(session()->get('language') == 'romanian') Dress @else Elegante @endif</a></li>
                      <li role="presentation"><a role="menuitem" tabindex="-1" href="category.html">- @if(session()->get('language') == 'romanian') Luxury @else Luxoase @endif</a></li>
                      <li role="presentation"><a role="menuitem" tabindex="-1" href="category.html">- @if(session()->get('language') == 'romanian') Smart @else Inteligente @endif</a></li>
                      <li role="presentation"><a role="menuitem" tabindex="-1" href="category.html">- @if(session()->get('language') == 'romanian') Sports   @else Sport @endif</a></li>
                      <li role="presentation"><a role="menuitem" tabindex="-1" href="category.html">- @if(session()->get('language') == 'romanian') Vintage @else Vintage @endif</a></li>
                    </ul>
                  </li>
                </ul>
                @if(session()->get('language') == 'romanian')
                <input class="search-field" onfocus="search_result_show()" onblur="search_result_hide()" id="search" name="search" placeholder="Cautati aici..." /> 
                 @else 
          ...
          <div class="navbar-collapse collapse" id="mc-horizontal-menu-collapse">
            <div class="nav-outer">
              <ul class="nav navbar-nav">
                ...
                @endforeach
                <li> <a href="{{ route('shop.page') }}">@if(session()->get('language') == 'romanian') Magazin @else Shop @endif</a> </li>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form method="post" action="{{route('order.tracking')}}">
          @csrf 
          <div class="modal-body">
            <label>@if(session()->get('language') == 'romanian') Cod factura @else Invoice code @endif</label>
              <input type="text" name="code" required="" class="form-control" placeholder="Your order invoice number">
          </div>
          <button class="btn btn-danger" type="submit" style="margin-left:17px;">@if(session()->get('language') == 'romanian') Urmareste @else Track now @endif</button>
        </form>
      </div>
    </div>
  </div>
